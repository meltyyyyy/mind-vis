...
class wandb_logger:
    def __init__(self, config):
        wandb.init(project="mind-vis", anonymous="allow", group="stageA_sc-mbm", config=config, reinit=True)
...
def main(config):
    ...
    dataset_pretrain = hcp_dataset(
        path=os.path.join(config.root_path, "data/HCP/npz"),
        roi=config.roi,
